...
const stats = [
  { icon: 'history',        value: '20+',  label: '년 업력' },
  { icon: 'groups',         value: '500+', label: '납품 고객사' },
  { icon: 'rocket_launch',  value: '300+', label: '개발 프로젝트' },
  { icon: 'verified',       value: '99%',  label: '고객 만족도' },
]
      ...
      <section id="home" className="hero">
        ...
        <div className="container hero-content">
          <div className="hero-badge">
            <Icon name="calendar_today" size="0.85rem" />
            Since 2003.09.23
          </div>
          ...
          <div className="hero-actions">
            <a href="#services" className="btn-primary">
              <Icon name="grid_view" size="1rem" />
              서비스 보기
            </a>
            <a href="#contact" className="btn-outline">
              <Icon name="mail_outline" size="1rem" />
              문의하기
            </a>
          </div>
        </div>
        ...
        <div className="container about-inner">
          <div className="about-text">
            <h2 className="section-title" style={{ textAlign: 'left' }}>
              20년 이상의<br /><span className="highlight-blue">전문 IT 기업</span>
            </h2>
            ...
            <a href="#contact" className="btn-primary about-cta">
              <Icon name="support_agent" size="1rem" />
              상담 신청
            </a>
          </div>
          <div className="about-visual">
            <div className="about-card">
              <Icon name="apartment" className="about-card-icon" />
              <div className="about-year">2003</div>
              <div className="about-year-label">창립연도</div>
            </div>
            <div className="about-card about-card--accent">
              <Icon name="workspace_premium" className="about-card-icon" />
      ...
      <section id="contact" className="section cta-section">
        <div className="container">
          <div className="cta-box">
            <Icon name="handshake" className="cta-icon" />
            <h2 className="cta-title">프로젝트를 시작할 준비가 되셨나요?</h2>
            <p className="cta-desc">지금 바로 문의하시면 전문 담당자가 빠르게 도와드립니다.</p>
            <a href="mailto:contact@gwphoenix.co.kr" className="btn-primary cta-btn">
